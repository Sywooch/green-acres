...
class Photo extends ActiveRecord
{
    ...
    Image::thumbnail('@webroot/uploads/uploads/' . $newPictureRandomName, $width, $height)
        ->save(Yii::getAlias('@webroot/uploads/thumbs/admin/' . $newPictureRandomName), ['quality' => 80]);
    ...
    Image::thumbnail('@webroot/uploads/uploads/' . $newPictureRandomName, $width, $height)
        ->save(Yii::getAlias('@webroot/uploads/thumbs/thumb/' . $newPictureRandomName), ['quality' => 80]);
    ...
    Image::thumbnail('@webroot/uploads/uploads/' . $newPictureRandomName, $width, $height)
        ->save(Yii::getAlias('@webroot/uploads/thumbs/cart_list/' . $newPictureRandomName), ['quality' => 80]);
    ...
    public function unlinkPhotos($id)
    {
        ...
        foreach ($photos as $photo) {
            ...
            if ($photo->file) {
                ...
                unlink((\Yii::getAlias('@webroot/uploads/thumbs/thumb/' . $photo->file)));
    ...
    public function getCatalogListPhotoFileUrl($productId, $photoId)
    {
        ...
        return Url::toRoute(@backend . '/web/uploads/thumbs/catalog_list/' . $photo->file);
