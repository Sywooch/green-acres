...
class ProductController extends Controller
{
    ...
    public function actionMovePhotoUp($productId, $photoId)
    {

        $this->service->movePhotoUp($productId, $photoId);
    ...
    public function actionMovePhotoDown($productId, $photoId)
    {
        ...
        $this->service->movePhotoDown($productId, $photoId);
    ...
    public function actionDeletePhoto($productId, $photoId)
    {
        try {
